...
<div class="col-md-9 main-content">
    ...
    <form method="post" action="https://aubo1.ace4news.com/blog_admin/categories/add_category" enctype="multipart/form-data">

        <input type="hidden" name="_token" value="HMuuwDnnSV0JloKIxavohjmh9ijProqGUgNIYfYh" autocomplete="off">
